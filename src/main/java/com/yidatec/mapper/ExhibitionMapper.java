...
public interface ExhibitionMapper {
	 ...
	 * @return
	 */
	@Select("SELECT id,name,address,start as startTime,createTime,creatorId,modifyTime,modifierId FROM T_EXHIBITION_HALL WHERE id = #{id}")
	 ...
	 * @return
	 */
	@Select("SELECT id,name,address,start as startTime,createTime,creatorId,modifyTime,modifierId FROM T_EXHIBITION_HALL")
