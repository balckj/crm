 ...
 * @author QuShengWen
 */
public class CustomLocalDateTime2Serializer extends JsonSerializer<LocalDateTime> {
    private final static DateTimeFormatter DATE_TIME_FORMAT = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm");
