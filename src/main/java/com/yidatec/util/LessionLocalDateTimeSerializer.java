 ...
 * @author QuShengWen
 */
public class LessionLocalDateTimeSerializer extends JsonSerializer<LocalDateTime> {
    private final static DateTimeFormatter DATE_TIME_FORMAT = DateTimeFormatter.ofPattern("HH:mm");
