...
import com.yidatec.model.Ledger2;
 ...
 *
 */
public class LedgerVO2 extends BaseModel {
	private static final long serialVersionUID = -140219923846563098L;

	// 台账保存的时候验证用
	@Valid
	private List<Ledger2> ledgerList;
	...
	public List<Ledger2> getLedgerList() {
		return ledgerList;
	}

	public void setLedgerList(List<Ledger2> ledgerList) {
